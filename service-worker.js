const CACHE='furusato-manager-2026-09-22-cache14';
const ASSETS=['./','./index.html','./details.html','./donations.html','./settings.html','./import_readout.html','./style.css','./app.js','./calculator.js','./data-model.js','./integration.js','./manifest.json'];
